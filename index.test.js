...
describe('Test NodeJS Frontend', () => {
  ...
  it('as a user i want to go to the add books page', async () => {
  ...
  it('as a user i want to go to the edit books page', async () => {
  ...
  it('as a user i want to go to the add auhtors page', async () => {
  ...
  it('as a user I want to save a author', async () => {
    await addAuthor();
    await driver.wait(until.titleContains('Authors'), 3000);
    await testTitle('Authors');
    const message = await driver.findElement(By.name('message')).getText();
  ...
  it('as a user I wnat to edit an author', async () => {
    await editAuthor();
    await setDelay();
    await driver.wait(until.titleContains('Authors'), 2000);
    await testTitle('Authors');
    const message = await driver.findElement(By.name('message')).getText();
  ...
  it('as a user I want to render the about page', async () => {
    ...
    await driver.wait(until.titleContains('About'), 2000);
